...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}html,body{min-height:100%;margin:0}body{background:var(--page);color:var(--ink);font-family:var(--font);font-size:.9rem;overflow-x:hidden}a{color:var(--primary)}
        ...
        .topbar{position:fixed;top:0;inset-inline-start:var(--sidebar-w);inset-inline-end:0;height:var(--top-h);background:rgba(255,255,255,.96);backdrop-filter:blur(12px);z-index:1030;border-bottom:1px solid var(--line);display:flex;align-items:center;gap:.7rem;padding:0 1.2rem;box-shadow:0 2px 12px rgba(20,45,60,.04)}.topbar-title{font-weight:800;font-size:1rem;flex:1;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.top-action{width:38px;height:38px;border:1px solid var(--line);background:#fff;border-radius:10px;display:grid;place-items:center;color:#60717d;position:relative;transition:.15s ease;padding:0}.top-action:hover{border-color:#b9d3dc;background:var(--primary-soft);color:var(--primary)}.top-action .avatar{width:30px;height:30px;flex-basis:30px;border-width:1px}.topbar .dropdown{flex:0 0 auto}.main-content{margin-inline-start:var(--sidebar-w);padding:1.35rem;min-height:100vh;padding-top:calc(var(--top-h) + 1.35rem);width:auto;min-width:0}html[dir="rtl"] .main-content{margin-inline-start:0;margin-inline-end:var(--sidebar-w)}
        ...
        @media(max-width:600px){.main-content{padding:1rem;padding-top:calc(var(--top-h) + 1rem)}.notifications-dropdown{width:290px}.page-header{align-items:flex-start;flex-wrap:wrap;padding:.9rem}.page-header>div:last-child{width:100%;margin-inline-start:0!important}.topbar{padding:0 .65rem;gap:.45rem}.topbar-title{font-size:.9rem}.top-action{width:36px;height:36px}.topbar form.d-sm-block{display:none!important}.card-body{padding:.85rem}.stat-card{min-height:92px;padding:.8rem}.stat-value{font-size:1.3rem}.dropdown-menu{font-size:.78rem}}
        @media(max-width:380px){.topbar-title{max-width:120px}.brand{padding-inline:.85rem}.sidebar{width:236px}}
        @stack('styles')
    </style>
</head>
<body>

...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}html,body{min-height:100%;margin:0}body{background:var(--page);color:var(--ink);font-family:var(--font);font-size:.9rem;overflow-x:hidden}a{color:var(--primary)}
        ...
        @media(max-width:900px){:root{--sidebar-w:0px}.sidebar{width:248px;inset-inline-start:0;inset-inline-end:auto;transform:translateX(-100%)}html[dir="rtl"] .sidebar{inset-inline-start:auto;inset-inline-end:0;transform:translateX(100%)}.sidebar.open{transform:translateX(0)}.sidebar.open~.sidebar-overlay{display:block;opacity:1;pointer-events:auto}.topbar{inset-inline:0!important}.main-content,html[dir="rtl"] .main-content{margin-inline:0!important}.mobile-only{display:grid}}
...
<body>
    ...
    <header class="topbar">
        ...
        <div class="topbar-actions">
            <div class="dropdown">
                <button class="top-action language-action" type="button" data-bs-toggle="dropdown" aria-expanded="false" title="{{ __('Language') }}">
                    <i class="fa-solid fa-language"></i><span class="language-label">{{ app()->getLocale()==='ar' ? 'العربية' : 'English' }}</span><i class="fa-solid fa-chevron-down" style="font-size:.62rem"></i>
                </button>

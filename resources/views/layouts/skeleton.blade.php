...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}body{margin:0;background:var(--page);color:var(--ink);font-family:var(--font);font-size:.9rem;overflow-x:hidden}a{color:var(--primary)}
        .sidebar{position:fixed;top:0;bottom:0;inset-inline-start:0;width:var(--sidebar-w);background:linear-gradient(180deg,var(--sidebar),var(--sidebar-dark));z-index:1040;display:flex;flex-direction:column;box-shadow:0 0 30px rgba(10,30,45,.16);transition:transform .2s ease}
        html[dir="rtl"] .sidebar{inset-inline-start:auto;inset-inline-end:0}
        ...
        @media(max-width:600px){.main-content{padding:1rem;padding-top:calc(var(--top-h) + 1rem)}.notifications-dropdown{width:290px}.page-header{align-items:flex-start;flex-wrap:wrap}.page-header>div:last-child{width:100%;margin-inline-start:0!important}}
        @stack('styles')
    </style>
</head>
<body>

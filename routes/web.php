...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('containers', [ContainerController::class, 'store'])->name('containers.store')->middleware('permission:create containers');
    Route::post('containers/import/excel', [ContainerController::class, 'import'])->name('containers.import')->middleware('permission:create containers');
    ...
    Route::delete('containers/{container}', [ContainerController::class, 'destroy'])->name('containers.destroy')->middleware('permission:delete containers');
    ...
    Route::post('vehicles/import/excel', [VehicleController::class, 'import'])->name('vehicles.import')->middleware('permission:create vehicles');
    ...
    Route::post('drivers/import/excel', [DriverController::class, 'import'])->name('drivers.import')->middleware('permission:create drivers');
    ...
    Route::post('routes', [RouteController::class, 'store'])->name('routes.store')->middleware('permission:create routes');
    ...
    Route::delete('routes/{route}', [RouteController::class, 'destroy'])->name('routes.destroy')->middleware('permission:delete routes');
    Route::post('routes/optimize', [RouteController::class, 'optimize'])->name('routes.optimize')->middleware('permission:optimize routes');

    // ===== Dumpsites =====
    Route::get('dumpsites', [DumpsiteController::class, 'index'])->name('dumpsites.index')->middleware('permission:view dumpsites');
    Route::post('dumpsites', [DumpsiteController::class, 'store'])->name('dumpsites.store')->middleware('permission:create dumpsites');
    ...
    Route::delete('dumpsites/{dumpsite}', [DumpsiteController::class, 'destroy'])->name('dumpsites.destroy')->middleware('permission:delete dumpsites');
    ...
    Route::post('complaints', [ComplaintController::class, 'store'])->name('complaints.store')->middleware('permission:create complaints');
    ...
    Route::delete('complaints/{complaint}', [ComplaintController::class, 'destroy'])->name('complaints.destroy')->middleware('permission:delete complaints');

    // ===== Reports =====
    Route::middleware('permission:view reports')->group(function () {
        Route::get('reports', [ReportController::class, 'index'])->name('reports.index');
    });
    Route::post('reports/generate', [ReportController::class, 'generate'])->name('reports.generate')->middleware('permission:generate reports');
...
// Public complaint submission. Rate-limited to reduce automated spam/abuse.
Route::get('/complaint/submit', [ComplaintController::class, 'create'])
    ->name('complaints.public')
    ->middleware('throttle:20,1');
Route::post('/complaint/submit', [ComplaintController::class, 'store'])
